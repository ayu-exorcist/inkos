...
export const createCreateSlice: StateCreator<ChatStore, [], [], CreateActions> = (set) => ({
  ...
  openArtifact: (file) =>
    set({ sidebarView: "artifact", artifactFile: file, artifactChapter: null }),
  openChapterArtifact: (chapterNum) =>
    set({ sidebarView: "artifact", artifactFile: null, artifactChapter: chapterNum }),
